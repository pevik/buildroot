...
#IMA_EVM_UTILS_VERSION = $(call qstrip,$(BR2_PACKAGE_IMA_EVM_UTILS_VERSION))
#IMA_EVM_UTILS_SITE = https://git.code.sf.net/p/linux-ima/ima-evm-utils
IMA_EVM_UTILS_VERSION = 1.1
IMA_EVM_UTILS_SITE = http://downloads.sourceforge.net/project/linux-ima/ima-evm-utils
#IMA_EVM_UTILS_SITE_METHOD = git
