...
define LTP_TESTSUITE_REMOVE_UNSUPPORTED_MUSL
	rm -f $(@D)/testcases/kernel/pty/pty01.c
	rm -f $(@D)/testcases/kernel/pty/pty02.c
	rm -f $(@D)/testcases/kernel/pty/ptem01.c
	rm -f $(@D)/testcases/kernel/sched/process_stress/process.c
	rm -f $(@D)/testcases/kernel/syscalls/accept4/accept4_01.c
	rm -f $(@D)/testcases/kernel/syscalls/confstr/confstr01.c
	rm -f $(@D)/testcases/kernel/syscalls/fmtmsg/fmtmsg01.c
	rm -f $(@D)/testcases/kernel/syscalls/getcontext/getcontext01.c
	rm -f $(@D)/testcases/kernel/syscalls/getdents/getdents01.c
	rm -f $(@D)/testcases/kernel/syscalls/getdents/getdents02.c
	rm -f $(@D)/testcases/kernel/syscalls/ioctl/ioctl01.c
	rm -f $(@D)/testcases/kernel/syscalls/ioctl/ioctl02.c
	rm -f $(@D)/testcases/kernel/syscalls/sched_getaffinity/sched_getaffinity01.c
	rm -f $(@D)/testcases/kernel/syscalls/setdomainname/setdomainname01.c
	rm -f $(@D)/testcases/kernel/syscalls/setdomainname/setdomainname02.c
	rm -f $(@D)/testcases/kernel/syscalls/sethostname/sethostname02.c
	rm -f $(@D)/testcases/misc/crash/crash01.c
